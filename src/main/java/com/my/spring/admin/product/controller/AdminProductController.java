...
public class AdminProductController {
	...
	public ResponseEntity addNewProduct(MultipartHttpServletRequest multipartRequest, HttpServletResponse response) throws Exception {
		...
		Enumeration enu=multipartRequest.getParameterNames(); //�Ķ���� name,value�ѹ��� ��������
		...
		HttpSession session=multipartRequest.getSession();//���ǿ��� ������̸� ��������
		...
		if(imageFileList !=null && imageFileList.size() !=0) { //null check
			for(ImageFileVO imageFileVO : imageFileList) {
				imageFileVO.setPro_register(register); //�� ���ϴ� ����ڵ��
			}
		...
		try {
			int pro_code=adminProductService.addNewProduct(newProductMap); //��ǰ���� ����ϰ� �ش� ��ǰ��ȣ ��������
